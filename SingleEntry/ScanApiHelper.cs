...
using System.Linq;
using ScanAPI;
//using ScanApiXamarin;

using Foundation; // for the definition of NSObject
...
namespace ScanAPI
{
    ...
    class CommandContext : NSObject
    {
        ...
        public CommandContext(bool getOperation,ISktScanObject scanObj,ISktScanDevice scanDevice,DeviceInfo deviceInfo,ICommandContextCallback callback){
			...
			scanObj.Property.SetContext(this);// EricG
    ...
    public class ScanApiHelper
    {
        ...
        public long DoScanAPIReceive()
        {
            ...
            if (_scanApiOpen)
            {
				ISktScanObject scanObj=new ISktScanObject();
        ...
        public void PostGetScanAPIVersion(ICommandContextCallback callback)
        {
			...
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdVersion);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeNone);
        ...
        {
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdDataConfirmationMode);
			newScanObj.Property.SetType((byte)ISktScanProperty.types.kSktScanPropTypeByte);
			newScanObj.Property.SetByte((byte)mode);
        ...
        public void PostSetDataConfirmation(DeviceInfo deviceInfo, ICommandContextCallback callback)
        {
			...
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdDataConfirmationDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeUlong);
			newScanObj.Property.SetUlong((nuint)
        ...
        public void PostGetBtAddress(DeviceInfo deviceInfo, ICommandContextCallback callback)
        {
			...
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
									newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdBluetoothAddressDevice);
									newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeNone);
        ...
        public void PostGetDeviceType(DeviceInfo deviceInfo, ICommandContextCallback callback)
        {
            ...
            // create and initialize the property to send to the device
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdDeviceType);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeNone);
        ...
        public void PostGetFirmware(DeviceInfo deviceInfo, ICommandContextCallback callback)
        {
            ...
            // create and initialize the property to send to the device
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdVersionDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeNone);
        ...
        public void PostStartDecode(DeviceInfo deviceInfo, ICommandContextCallback callback)
        {
            ...
            // create and initialize the property to send to the device
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdTriggerDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeByte);
			newScanObj.Property.SetByte((byte)ISktScanProperty.values.trigger.kSktScanTriggerStart);
        ...
        public void PostGetBattery(DeviceInfo deviceInfo, ICommandContextCallback callback)
        {
            ...
            // create and initialize the property to send to the device
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdBatteryLevelDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeNone);
        ...
        public void PostGetStandConfig(DeviceInfo deviceInfo, ICommandContextCallback callback)
        {
            ...
            // create and initialize the property to send to the device
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdStandConfigDevice);
				newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeNone);
        ...
        public void PostGetDecodeAction(DeviceInfo deviceInfo, ICommandContextCallback callback)
        {
            ...
            // create and initialize the property to send to the device
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdLocalDecodeActionDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeNone);
        ...
        public void PostGetCapabilitiesDevice(DeviceInfo deviceInfo, ICommandContextCallback callback)
        {
            ...
            // create and initialize the property to send to the device
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdCapabilitiesDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeByte);
			newScanObj.Property.SetByte((byte)ISktScanProperty.values.capabilityGroup.kSktScanCapabilityLocalFunctions);
        ...
        public void PostGetPostambleDevice(DeviceInfo deviceInfo, ICommandContextCallback callback)
        {
            ...
            // create and initialize the property to send to the device
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdPostambleDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeNone);
        ...
        public void PostGetSymbologyInfo(DeviceInfo deviceInfo, int symbologyId, ICommandContextCallback callback)
        {
            ...
            // create and initialize the property to send to the device
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdSymbologyDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeSymbology);
			newScanObj.Property.Symbology.SetFlags(ISktScanSymbology.flags.kSktScanSymbologyFlagStatus);
			newScanObj.Property.Symbology.SetID(symbologyId);
            // add the property and the device to the command context list
            // to send it as soon as it is possible
            CommandContext command = new CommandContext(true, newScanObj, device, deviceInfo, callback);
            AddCommand(command);
        ...
        public void PostSetSymbologyInfo(DeviceInfo deviceInfo, int Symbology, bool Status, ICommandContextCallback callback)
        {
			...
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeSymbology);
			newScanObj.Property.Symbology.SetFlags(ISktScanSymbology.flags.kSktScanSymbologyFlagStatus);
			newScanObj.Property.Symbology.SetID(Symbology);
			newScanObj.Property.Symbology.SetStatus (Status ? ISktScanSymbology.status.kSktScanSymbologyStatusEnable : ISktScanSymbology.status.kSktScanSymbologyStatusDisable);
        ...
        public void PostGetFriendlyName(DeviceInfo deviceInfo, ICommandContextCallback callback)
        {
            ...
            // create and initialize the property to send to the device
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdFriendlyNameDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeNone);
            // add the property and the device to the command context list
            // to send it as soon as it is possible
            CommandContext command = new CommandContext(true, newScanObj, device, deviceInfo, callback);
        ...
        public void PostSetFriendlyName(DeviceInfo deviceInfo, String friendlyName, ICommandContextCallback callback)
        {
			...
			ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdFriendlyNameDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeString);
			newScanObj.Property.SetString(friendlyName);
            CommandContext command = new CommandContext(false, newScanObj, device, null, callback);
            AddCommand(command);
        }
        ...
        public void PostSetStandConfig(DeviceInfo deviceInfo, int standConfig, ICommandContextCallback callback)
        {
			...
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdStandConfigDevice);
				newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeUlong);
			newScanObj.Property.SetUlong((nuint)standConfig);
            CommandContext command = new CommandContext(false, newScanObj, device, null, callback);
            AddCommand(command);
        }
        /**
        ...
        public void PostGetDeviceSpecific(DeviceInfo deviceInfo, Byte[] bArray, ICommandContextCallback callback)
        {
            ISktScanDevice device = deviceInfo.SktScanDevice;
            ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdDeviceSpecific);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeArray);
			IntPtr unmanagedPointer = Marshal.AllocHGlobal(bArray.Length);
			Marshal.Copy(bArray, 0, unmanagedPointer, bArray.Length);
			newScanObj.Property.SetArray(unmanagedPointer,bArray.Length);
        ...
        public void PostSetDecodeAction(DeviceInfo device, int decodeVal, ICommandContextCallback callback)
        {
			...
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdLocalDecodeActionDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeByte);
			newScanObj.Property.SetByte((byte)(decodeVal & 0xffff));
        ...
        {
            ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdSoundConfigDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeArray);
			IntPtr unmanagedPointer = Marshal.AllocHGlobal(bArray.Length);
			Marshal.Copy(bArray, 0, unmanagedPointer, bArray.Length);
			newScanObj.Property.SetArray(unmanagedPointer,bArray.Length);
        ...
        public void PostSetPostamble(DeviceInfo device, String suffix, ICommandContextCallback callback)
        {
			...
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdPostambleDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeString);
			newScanObj.Property.SetString(suffix);
        ...
        {
            ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdTimersDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeArray);
			IntPtr unmanagedPointer = Marshal.AllocHGlobal(bArray.Length);
			Marshal.Copy(bArray, 0, unmanagedPointer, bArray.Length);
			newScanObj.Property.SetArray(unmanagedPointer, bArray.Length);
        ...
        public void PostGetDataStore(DeviceInfo device, byte index, ICommandContextCallback callback)
        {
            ...
            ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdDataStoreDevice);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeArray);
			IntPtr unmanagedPointer = Marshal.AllocHGlobal(bArray.Length);
			Marshal.Copy(bArray, 0, unmanagedPointer, bArray.Length);
			newScanObj.Property.SetArray (unmanagedPointer, bArray.Length);
        ...
        public void PostScanApiAbort(ICommandContextCallback callback)
        {
            // create and initialize the property to send to the device
            ISktScanObject newScanObj = SktClassFactory.CreateScanObject();
			newScanObj.Property.SetID(ISktScanProperty.propId.kSktScanPropIdAbort);
			newScanObj.Property.SetType(ISktScanProperty.types.kSktScanPropTypeNone);
        ...
        {
            bool closeScanApi = false;
			switch ((int)scanObject.Msg.MsgID)
            {
        ...
        {
			ISktScanDevice iDevice=scanObject.Msg.HDevice;
		    ...
		    case ISktScanEvent.id.kSktScanEventError:
			    if(_notification!=null){
			        _notification.OnError(scanObject.Msg.Result,
						Event.DataType == (ESktEventDataType)ISktScanEvent.types.kSktScanEventDataTypeString ? Event.DataString : null);
			    }
			    break;
